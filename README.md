...
## Assumptions ##
-   [Arduino 101](https://www.arduino.cc/en/Guide/Arduino101)
-   Node.js is installed on Windows
-   Node-RED node node-red-node-serialport is installed on Windows
-   Node-RED is installed on Windows and is running
